...
class Judge(dspy.Signature):
    ...
    decision: Literal["useful", "not useful"] = dspy.OutputField(
        desc="""Return 'useful' ONLY IF BOTH of the following are true:
            1. The generated_reasoning conveys the same core insight as correct_reasoning — it identifies the key data point (e.g., the label or trait) using equivalent meaning, even if phrased differently.
